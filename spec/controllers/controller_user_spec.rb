...
describe UserController do
  ...
  context 'methods' do
    ...
    it 'allows authenticated access' do
      ...
      #   delete :destroy, params: {id: subordinate.id}
      ...
      #   user
      #   subordinate = User.create(id: 2, name: 'test2', email: 'test2@abv.bg', password: '123123', role: 'User', owner_id: 1)
      #   delete :compound_destroy, params: {id: 2}
      #   expect(User.count).to be 0
      #
      # end

      # it 'User has been sussessfully created via controller user and action create' do
      #   user
